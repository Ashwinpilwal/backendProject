...
const Footer = () => {
  return (
    // <div className='flex bg-black text-white justify-center items-center h-8'>
    //   Footer
    // </div>
    <footer className="footer sm:footer-horizontal bg-black text-white items-center p-4 flex justify-between">
